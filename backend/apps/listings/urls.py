...
from apps.listings.views import (
    ...
    BlockedPeriodsView, BlockedPeriodDetailView,
)
...
urlpatterns = [
    ...
    path("<uuid:listing_id>/blocked-periods/", BlockedPeriodsView.as_view(), name="blocked-periods"),
    path("<uuid:listing_id>/blocked-periods/<uuid:period_id>/", BlockedPeriodDetailView.as_view(), name="blocked-period-detail"),
